...
import com.harvey.common.provider.HttpServletRequestProvider;
...
public class ApiLogAspect {
    ...
    public ApiLogAspect(HttpServletRequestProvider httpServletRequestProvider) {
        this.httpServletRequestProvider = httpServletRequestProvider;
    }
    
    @Around("execution(* com.harvey..controller..*(..))")
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        HttpServletRequest req = httpServletRequestProvider.getRequest();
