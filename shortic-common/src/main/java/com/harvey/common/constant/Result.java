...
public class Result<T> {
    ...
    public static <T> Result<T> forbidden(int code, String message) {
        return failure(code, message, null);
    }
    
    public static <T> Result<T> forbidden(int code, String message, T data) {
        return new Result<>(code, message, data);
    }
    ...
    public static <T> Result<T> unauthorized(int code, String message) {
        return failure(code, message, null);
    }
    
    public static <T> Result<T> unauthorized(int code, String message, T data) {
        return new Result<>(code, message, data);
    }
